...
st.title('🏋️‍♂️ Reporte de Progreso en el Gimnasio 🏋️‍♀️')
...
if st.session_state.get('show_enfoque_form', False):
    with st.form(key='mi_formulario'):
        ...
        Persona = st.selectbox('👤 Selecciona tu nombre:', ('Carlos', 'Cinthia'))
        Maquina = st.selectbox('💪 Selecciona una máquina:', ('Prensa de Piernas', 'Multipowers', 'Máquina de Extensión de Cuádriceps', 'Máquina de Femorales', 'Máquina de Aductores', 'Máquina de Abductores','Press de pecho','Extension de hombro',
...
fig_line_sets = px.line(st.session_state['Progreso_ind'], x='Día', y='Sets', color='Persona', markers=True, title='Número de series por día', color_discrete_map={'Carlos': 'black', 'Cinthia': 'skyblue'})
