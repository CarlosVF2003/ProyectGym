    ...
    if form_completo:
        ...
        if st.button('Guardar'):
            ...
            if Enfoque != 'Hipertrofia Muscular':
                st.session_state['Progreso_ind']['Sets'] = st.session_state['Progreso_ind'].groupby(['Dia', 'Persona',, 'Repeticiones', 'Maquina', 'Peso','Descanso'])[['Peso', 'Repeticiones']].transform('size')
