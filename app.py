...
if 'Progreso_ind' in st.session_state:
    ...
    fig_linea.update_traces(line_color=['rgb(0,0,0)', 'rgb(173,216,230)'])  # Colores Negro y Celeste Claro en formato RGB
    ...
    fig_barras.update_traces(marker_color=['rgb(0,0,0)', 'rgb(173,216,230)'])  # Colores Negro y Celeste Claro en formato RGB
    st.plotly_chart(fig_barras)

    # Histograma de Pesos
    fig_hist = px.histogram(st.session_state['Progreso_ind'], x='Peso', color='Persona', title='Histograma de Pesos')
    fig_hist.update_traces(marker_color=['rgb(0,0,0)', 'rgb(173,216,230)'])  # Colores Negro y Celeste Claro en formato RGB
    ...
    fig_dispersion.update_traces(marker_color=['rgb(0,0,0)', 'rgb(173,216,230)'])  # Colores Negro y Celeste Claro en formato RGB
